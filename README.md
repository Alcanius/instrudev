...
La sección de habilidades incluye barras de progreso animadas que se llenan cuando aparecen en pantalla. Además, el bloque **About** muestra una imagen de perfil, datos personales y un botón para descargar el CV con un watermark decorativo de fondo.

Cada tarjeta de curso incluye un botón **Inscribirse** que abre un modal para registrar nombre completo, teléfono, correo, género y edad.
